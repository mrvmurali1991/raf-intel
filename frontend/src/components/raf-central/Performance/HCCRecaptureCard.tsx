    ...
    <div className="px-4 py-3 space-y-4">
      ...
      <div className="flex items-center gap-3">
        <div>
          ...
          <div className="text-sm font-bold tabular-nums">${financial.current_annual.toLocaleString()}</div>
        </div>
        ...
        <div>
          ...
          <div className="text-sm font-bold tabular-nums">${financial.projected_annual.toLocaleString()}</div>
        </div>
      </div>
      {/* Area chart */}
      {financial.annual_delta > 0 && (
        <FinancialAreaChart
      ...
      {financial.annual_delta > 0 && (
        <div className="rounded-md border border-emerald-200 bg-emerald-50 dark:border-emerald-800 dark:bg-emerald-950/30 px-3 py-2">
          ...
          <div className="text-base font-bold tabular-nums text-foreground">
            +${financial.annual_delta.toLocaleString()}
