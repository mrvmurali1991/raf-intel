...
export default function Error({
  ...
  useEffect(() => {
    ...
    console.error("[v28-impact route]", error.digest ?? "boundary hit");
  }, [error]);
  ...
  return (
    ...
    >
      <h2 className="text-lg font-semibold">V28 Impact failed to load</h2>
      <p className="mt-2 text-sm text-muted-foreground">
        Could not load the V24→V28 transition impact view. Try again in a moment.
      </p>
      <button
        type="button"
        onClick={() => reset()}
