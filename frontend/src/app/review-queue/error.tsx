...
/**
 * Route error boundary for /review-queue.
...
export default function Error({
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      console.error("[review-queue route]", error.digest ?? "boundary hit");
    }
  }, [error]);
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        We couldn&apos;t load the review queue. Try again in a moment.
      </p>
      <button
        type="button"
        onClick={() => reset()}
