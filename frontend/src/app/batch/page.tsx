...
// ── Dynamic import: defer results summary until batch completes (~25 kB) ──
const BatchResultsPanel = dynamic(
  () => import("./BatchResultsPanel"),
  {
    ssr: false,
    loading: () => (
...
export default function BatchAnalysisPage() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto rci-page-pad-desktop" style={{ padding: "20px 16px" }}>
      ...
      {/* Section 3: Results Summary — lazy-loaded via BatchResultsPanel */}
      {isComplete && results.length > 0 && (
        <BatchResultsPanel results={results} processed={processed} newHccs={newHccs} />
      )}
