...
import { Shield, FileDown, Loader2, CheckCircle2, Search, X, ChevronDown, Package, ClipboardList, CheckSquare, PlayCircle } from "lucide-react";
...
const RADV_SCENARIOS: RadvScenario[] = [
  {
    id: "radv-2024-cohort-a",
    name: "RADV 2024 Cohort A",
    charts: 50,
    status: "active",
    description: "Primary CMS submission — high-RAF members, 2024 DOS",
  },
  {
    id: "mock-cms-audit-q3",
    name: "Mock CMS Audit Q3",
    charts: 30,
    status: "complete",
    description: "Internal dry-run simulating CMS RADV sample selection",
  },
  {
    id: "internal-qa-sample",
    name: "Internal QA Sample",
    charts: 20,
    status: "draft",
    description: "Coder QA cross-check — not yet submitted for review",
  },
];
...
function RadvScenariosCard() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <span style={{ fontSize: 12, color: "#94A3B8" }}>
            Select a scenario to scope your audit package
          </span>
        </div>
      </div>
      ...
      <ul
        role="listbox"
        aria-label="RADV audit scenarios"
            ...
            <li
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter" || e.key === " ") {
                  e.preventDefault();
                  setSelected(isSelected ? null : scenario.id);
                }
              }}
              tabIndex={0}
              style={{
                ...
                padding: "16px 24px",
                gap: 16,
                borderBottom: idx < RADV_SCENARIOS.length - 1 ? "1px solid #F1F5F9" : "none",
      ...
      {selected && (
        ...
        >
          ...
          <button
            ...
            onClick={() => {
              const el = document.getElementById("generate-audit-section");
