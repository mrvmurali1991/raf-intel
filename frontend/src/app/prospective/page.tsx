        ...
        {scheduled ? (
          ...
          <button
            ...
            style={{
              ...
              padding: "6px 12px",
              borderRadius: 7,
              border: `1px solid ${isHistoricalPY ? C.slate200 : C.primary}`,
              background: isHistoricalPY ? C.slate100 : `${C.primary}0D`,
              fontSize: 12,
              fontWeight: 600,
              color: isHistoricalPY ? C.slate400 : C.primary,
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <button
              ...
              style={{
                ...
                border: `1px solid ${C.slate200}`,
                background: isHistoricalPY ? C.slate100 : C.white,
                color: isHistoricalPY ? C.slate400 : C.slate600,
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 9,
                border: "none",
                background: isHistoricalPY ? C.slate200 : C.primary,
                color: C.white,
                fontSize: 13,
                fontWeight: 600,
                cursor: isHistoricalPY ? "not-allowed" : "pointer",
