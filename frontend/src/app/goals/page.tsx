    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 space-y-5 mx-4">
        <div className="flex items-center justify-between">
          <h2 id="set-goal-title" className="text-lg font-semibold text-slate-800 flex items-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            />
            <p className="text-xs text-slate-400">Format: YYYY-QN (e.g. 2026-Q2)</p>
          </div>
