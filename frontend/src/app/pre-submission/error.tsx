...
export default function Error({
  ...
  useEffect(() => {
    ...
    console.error("[pre-submission route]", error.digest ?? "boundary hit");
  }, [error]);
  ...
  return (
    ...
    >
      <h2 className="text-lg font-semibold">Pre-submission validator failed</h2>
      <p className="mt-2 text-sm text-muted-foreground">
        We couldn&apos;t load coding-rule findings. Please try again in a moment.
      </p>
      <button
        type="button"
        onClick={() => reset()}
