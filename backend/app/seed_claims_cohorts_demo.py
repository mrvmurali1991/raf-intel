...
DASHBOARD_ALERTS = [
    ("attestation_needed", "high", "HCC Recapture Due", "3 patients have HCC codes from prior year that have not been recaptured in 2026. Immediate provider review recommended.", None, None, {"deadline": "2026-04-30", "hcc_codes": ["HCC 85", "HCC 18", "HCC 96"], "patient_ids": [6, 16, 28]}, 0, None, "default"),
    ("new_suspect", "medium", "New Suspect Condition Identified", "NLP analysis of recent clinical notes identified a potential undiagnosed condition for patient. Review recommended.", 19, None, {"source": "clinical_notes", "confidence": 0.87, "document_id": 42, "suspect_hcc": "HCC 111"}, 0, None, "default"),
    ("system", "high", "AWV Completion Below Target", "Annual Wellness Visit completion rate is at 65%, which is below the 80% organizational target. 10 patients still pending.", None, None, {"cohort_id": 5, "target_rate": 0.8, "current_rate": 0.65, "patients_pending": 10}, 0, None, "default"),
    ("attestation_needed", "medium", "Pending Provider Attestations", "Dr. Martinez has 5 HCC coding attestations pending review. These must be completed before the next submission deadline.", None, "1234567890", {"deadline": "2026-04-15", "pending_count": 5, "provider_name": "Dr. Martinez"}, 0, None, "default"),
    ("claim_processed", "low", "Claims Batch Processed", "Claims batch #2026-Q1-047 has been processed successfully. 12 new HCC codes were mapped from submitted diagnosis codes.", None, None, {"batch_id": "2026-Q1-047", "total_claims": 87, "new_hcc_count": 12, "processing_time_sec": 14}, 1, None, "default"),
    ("raf_change", "low", "RAF Scores Updated After Document Analysis", "RAF scores increased for 8 patients following NLP-driven document analysis of uploaded clinical records.", None, None, {"analysis_date": "2026-03-28", "avg_raf_increase": 0.15, "patients_affected": 8, "documents_analyzed": 23}, 1, None, "default"),
    ...
    ("system", "high", "RADV Audit Preparation Deadline", "Quarterly RADV audit preparation deadline is in 30 days. Ensure all supporting documentation is uploaded and attestations are complete.", None, None, {"deadline": "2026-05-06", "audit_type": "RADV", "completion_pct": 0.35, "records_to_review": 45}, 0, None, "default"),
    ("raf_change", "medium", "Significant RAF Drop Detected", "Patient RAF score decreased by 0.45 in latest recalculation. Verify if HCC codes were intentionally removed or if this is a data issue.", 2, None, {"current_raf": 2.27, "recalc_date": "2026-04-01", "dropped_hccs": ["HCC 96"], "previous_raf": 2.72}, 0, None, "default"),
    ("system", "medium", "Star Rating Measure Gap", "HEDIS measure gap detected: 4 diabetic patients in the Diabetes Management cohort are overdue for retinal eye exam.", None, None, {"measure": "Diabetic Retinal Eye Exam", "cohort_id": 3, "gap_count": 4, "patient_ids": [10, 12, 20, 26]}, 0, None, "default"),
]
