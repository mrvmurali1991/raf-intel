...
# NOTE: GET /api/v1/dashboard/kpi-trends has been moved to app.routers.dashboard.
# The handler now lives in dashboard.py and is registered via router_registry.py.
