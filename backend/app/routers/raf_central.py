...
class AcceptSuspectRequest(BaseModel):
    ...
    force: bool = Field(
        default=False,
        description=(
            "If true, treat as a force-accept (e.g. coder overrode a soft MEAT gate). "
            "Recorded in audit as raf_intelligence_force_accept; otherwise "
            "raf_intelligence_normal_accept."
        ),
    )
