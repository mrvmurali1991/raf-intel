...
that demonstrate Monitoring, Evaluation, Assessment, or Treatment (MEAT) for
the condition during this face-to-face encounter.
...
6. **Assessed (A):** clinical assessment/status statement, differential, or
   severity ("DM2 uncontrolled", "CKD stage 3, stable").
