            ...
            if existing_id:
                ...
                cur.execute(
                    """UPDATE patients SET
                           ...
                           ethnicity = COALESCE(NULLIF(%s, ''), ethnicity),
                    ...
                    (
                        ...
                        patient.get("language") or "",
                        patient.get("race") or "",
                        patient.get("ethnicity") or "",
                ...
                cur.execute(
                    """INSERT INTO patients
                       ...
                       ON DUPLICATE KEY UPDATE
                           ...
                           phone      = VALUES(phone),
                           email      = VALUES(email),
                           preferred_language = COALESCE(NULLIF(VALUES(preferred_language), ''), preferred_language),
                           race       = COALESCE(NULLIF(VALUES(race), ''), race),
                           ethnicity  = COALESCE(NULLIF(VALUES(ethnicity), ''), ethnicity),
