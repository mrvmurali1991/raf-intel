...
class TestDetectRecurringGaps:
    ...
    def test_three_year_recurring_gap_flagged(self) -> None:
    ...
    def test_two_year_recurring_gap_flagged(self) -> None:
    ...
    def test_lookback_window_excludes_old_gaps(self) -> None:
    ...
    def test_recaptured_year_recorded_in_last_recapture(self) -> None:
...
class TestGetRecurringGaps:
    ...
    def test_returns_enriched_rows(self) -> None:
        rows = [
            {
                "id": 303,
                "patient_id": 42,
...
class TestSuggestAWVForGap:
    ...
    def test_eligible_patient_returns_two_week_window(self) -> None:
        gap_row = {
            "id": 303,
            "patient_id": 42,
            "tenant_id": "1",
    ...
    def test_ineligible_patient_returns_recommendation(self) -> None:
        gap_row = {
            "id": 11,
            "patient_id": 99,
            "tenant_id": "1",
    ...
    def test_missing_gap_raises_value_error(self) -> None:
...
class TestMarkAWVScheduled:
    ...
    def test_updates_row_when_present(self) -> None:
        cm = _cursor_with_calls([
