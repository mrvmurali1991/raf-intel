...
class TestRAPSFileFormat:
    ...
    def test_a_header_record_length(self) -> None:
    ...
    def test_a_header_record_type_at_position_1(self) -> None:
        """Position 1 (index 0) must be the literal character 'A'."""
        rec = _raps_header(PLAN_ID, PAYMENT_YEAR, SWEEP_TYPE)
        assert rec[0] == "A", f"Expected 'A' at pos 1, got {rec[0]!r}"

    def test_a_header_plan_id_positions_2_to_12(self) -> None:
        """
    ...
    def test_a_header_payment_year_positions_13_to_16(self) -> None:
    ...
    def test_a_header_sweep_type_positions_17_to_21(self) -> None:
    ...
    def test_a_header_submission_date_positions_22_to_29(self) -> None:
        """
    ...
    def test_a_header_filler_all_spaces(self) -> None:
    ...
    def test_a_header_truncated_plan_id(self) -> None:
    ...
    def test_b_detail_record_length(self) -> None:
    ...
    def test_b_detail_record_type_at_position_1(self) -> None:
    ...
    def test_b_detail_mbi_positions_2_to_13(self) -> None:
        """
    ...
    def test_b_detail_mbi_format_alphanumeric(self) -> None:
    ...
    def test_b_detail_npi_positions_14_to_23(self) -> None:
        """
    ...
    def test_b_detail_provider_type_positions_24_to_25(self) -> None:
    ...
    def test_b_detail_delete_indicator_position_26(self) -> None:
    ...
    def test_b_detail_delete_indicator_can_be_D(self) -> None:
    ...
    def test_b_detail_icd10_positions_27_to_33(self) -> None:
        """
    ...
    def test_b_detail_icd10_no_dot_stored(self) -> None:
    ...
    def test_b_detail_icd10_uppercased(self) -> None:
    ...
    def test_b_detail_dos_from_positions_34_to_41(self) -> None:
        """
    ...
    def test_b_detail_dos_through_positions_42_to_49(self) -> None:
        """
    ...
    def test_b_detail_payment_year_positions_50_to_53(self) -> None:
    ...
    def test_b_detail_filler_all_spaces(self) -> None:
    ...
    def test_z_trailer_record_length(self) -> None:
    ...
    def test_z_trailer_record_type_at_position_1(self) -> None:
        """Position 1 (index 0) must be the literal character 'Z'."""
        rec = _raps_trailer(PLAN_ID, record_count=42)
        assert rec[0] == "Z"

    def test_z_trailer_plan_id_positions_2_to_12(self) -> None:
    ...
    def test_z_trailer_record_count_positions_13_to_21(self) -> None:
        """
    ...
    def test_z_trailer_record_count_zero_padded(self) -> None:
    ...
    def test_z_trailer_filler_all_spaces(self) -> None:
    ...
    def test_full_file_all_records_same_length(self) -> None:
    ...
    def test_date_format_no_dashes_in_detail(self) -> None:
    ...
    def test_numeric_year_zero_padded_in_trailer(self) -> None:
    ...
    def test_alpha_mbi_space_padded_when_short(self) -> None:
...
class TestEDPS837PFormat:
    ...
    def test_isa_element_separator_is_star(self) -> None:
    ...
    def test_isa_version_is_00501(self) -> None:
    ...
    def test_isa_control_number_zero_padded_to_9(self) -> None:
    ...
    def test_isa_sender_id_padded_to_15(self) -> None:
    ...
    def test_isa_receiver_id_padded_to_15(self) -> None:
    ...
    def test_isa_date_is_6_digits_yymmdd(self) -> None:
    ...
    def test_isa_time_is_4_digits_hhmm(self) -> None:
    ...
    def test_isa_qualifier_codes_are_zz(self) -> None:
    ...
    def test_isa_special_chars_sanitized_in_ids(self) -> None:
        """
    ...
    def test_gs_functional_id_is_hc(self) -> None:
    ...
    def test_gs_version_is_005010x222a1(self) -> None:
    ...
    def test_gs_date_is_8_digits_yyyymmdd(self) -> None:
    ...
    def test_ge_trailer_format(self) -> None:
    ...
    def test_iea_trailer_matches_isa_control_number(self) -> None:
    ...
    def test_iea_interchange_count_is_1(self) -> None:
    ...
    def test_claim_segment_contains_clm(self) -> None:
    ...
    def test_claim_segment_contains_dtp_472(self) -> None:
    ...
    def test_dtp_date_range_no_dashes_in_individual_dates(self) -> None:
        """
    ...
    def test_hi_diagnosis_segment_uses_abk_qualifier(self) -> None:
    ...
    def test_hi_icd10_has_dot_removed(self) -> None:
        """
    ...
    def test_nm1_rendering_provider_qualifier_82(self) -> None:
    ...
    def test_nm1_facility_qualifier_77(self) -> None:
    ...
    def test_nm1_omitted_when_npi_empty(self) -> None:
    ...
    def test_all_segments_end_with_tilde(self) -> None:
...
class TestSubmissionDataIntegrity:
    ...
    def test_no_truncated_icd10_codes(self) -> None:
        """
    ...
    def test_no_truncated_npi(self) -> None:
        """
    ...
    def test_npi_exactly_10_digits(self) -> None:
    ...
    def test_mbi_validation_cms_format(self) -> None:
        """
    ...
    def test_mbi_no_invalid_cms_characters(self) -> None:
        """
    ...
    def test_normalize_date_8_handles_empty_string(self) -> None:
        """_normalize_date_8 must return 8 spaces for an empty string."""
        result = _normalize_date_8("")
        assert result == " " * 8, f"Expected 8 spaces, got {result!r}"

    def test_icd10_longer_than_7_chars_truncated_safely(self) -> None:
        """
    ...
    def test_plan_id_longer_than_11_chars_truncated_safely(self) -> None:
        """
    ...
    def test_dos_from_after_dos_through_still_writes_valid_record(self) -> None:
        """
...
class TestGenerateRAPSFileMocked:
    ...
    def test_generate_raps_record_count_matches_trailer(self, hcc_rows, tmp_path) -> None:
        """
    ...
    def test_generate_raps_first_line_is_a_header(self, hcc_rows, tmp_path) -> None:
    ...
    def test_generate_raps_last_line_is_z_trailer(self, hcc_rows, tmp_path) -> None:
    ...
    def test_generate_raps_icd10_in_file_has_no_dot(self, hcc_rows, tmp_path) -> None:
...
class TestGenerateEDPSFileMocked:
    ...
    def test_generate_edps_file_starts_with_isa(self, hcc_rows, tmp_path) -> None:
    ...
    def test_generate_edps_file_ends_with_iea(self, hcc_rows, tmp_path) -> None:
    ...
    def test_generate_edps_file_contains_hi_abk(self, hcc_rows, tmp_path) -> None:
    ...
    def test_generate_edps_isa_control_matches_iea(self, hcc_rows, tmp_path) -> None:
